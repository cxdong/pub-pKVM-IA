...
#if defined(CONFIG_CALL_PADDING) && (!defined(__DISABLE_EXPORTS) || defined(__PKVM_HYP__)) && !defined(BUILD_VDSO)
#define FUNCTION_PADDING	.skip CONFIG_FUNCTION_ALIGNMENT, 0x90;
#else
#define FUNCTION_PADDING
#endif

#if (CONFIG_FUNCTION_ALIGNMENT > 8) && (!defined(__DISABLE_EXPORTS) || defined(__PKVM_HYP__)) && !defined(BUILD_VDSO)
...
#if defined(CONFIG_MITIGATION_RETHUNK) && (!defined(__DISABLE_EXPORTS) || defined(__PKVM_HYP__)) && !defined(BUILD_VDSO)
